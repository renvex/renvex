...
const getCards = () => [
  {
    ...
    subtitle: 'Consistency and stability under live market conditions.',
    description:
  ...
  },
  {
    ...
    subtitle: 'Complete transparency with no hidden costs.',
    description:
  ...
  },
  {
    title: (
      <>
        Liquidity <br /> Consistency
      </>
    ),
    subtitle: 'Verified depth of market and sustainable execution quality.',
    description:
      ...
      <section className="flex flex-col items-center gap-4 text-center">
        <Chip>
          <Text
            size="lg"
            weight={500}
            className="max-md:text-base max-md:break-words"
          >
            A data-driven framework for broker evaluation
          </Text>
        </Chip>
        <Title as="h3" size="6xl">
          Precision in <span className="text-blue-70">Selection</span>
        </Title>
        <Text color="grey" className="w-[700px] text-center max-md:w-full">
          Renvex applies a continuous monitoring system to assess and verify
          broker performance in real time. Every platform is analyzed using
          verified data streams and measurable criteria, ensuring that only the
          most consistent and transparent brokers remain visible.
        </Text>
      </section>
  ...
  return (
    <li className="relative flex flex-col items-center justify-center gap-5 overflow-hidden rounded-[48px] bg-[radial-gradient(191.04%_100.15%_at_15.32%_0%,var(--color-grey-9,#171818)_0%,var(--color-grey-6,#101010)_66.17%)] px-20 py-10 text-center max-md:px-4">
      ...
      <Text size="2xl" className="w-[700px] max-lg:text-lg max-md:w-full">
        A refined network of brokers that meet institutional-grade standards for
        performance, transparency, and reliability. Every inclusion is earned —
        never purchased.
      </Text>
      <Image
